...
<head>
    ...
    {{-- {!! SEOMeta::generate() !!} --}}
    <title>@yield('title', 'Kumo - Fashion eCommerce HTML Template')</title>
...
<body>
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/63c273d2c2f1ac1e202d66df/1gmnp8sde';
            s1.charset = 'UTF-8';
                            ...
                            <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
                                    ...
                                    <div class="cart_single_caption pl-2">
                                        ...
                                        <p class="mb-2"><span class="text-dark ft-medium small"></span></p>
                                        <h4 class="fs-md ft-medium mb-0 lh-1">BDT
                                            {{ $wishlist->rel_to_product->after_discount }}</h4>
                                    </div>
                                </div>
                                <div class="fls_last"><a href="{{ route('remove.wishlist', $wishlist->id) }}"
                            ...
                            <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
                                    ...
                                    <div class="cart_single_caption pl-2">
                                        ...
                                        <p class="mb-2"><span class="text-dark ft-medium small">QTY:
