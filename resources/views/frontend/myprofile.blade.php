                    ...
                    <form class="row m-0" action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="{{ Auth::guard('customerlogin')->user()->phone }}" class="form-control" placeholder="+1 (253) 586-8546" />
                            </div>
                        </div>

                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="small text-dark ft-medium">Country<span style="font-size: 8px"> (Optional)</span> </label>
                                <input type="text" name="country" value="{{ Auth::guard('customerlogin')->user()->country }}" class="form-control" placeholder="Country" />
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="small text-dark ft-medium">Address<span style="font-size: 8px"> (Optional)</span></label>
                                <input type="text" name="address" value="{{ Auth::guard('customerlogin')->user()->address }}" class="form-control" placeholder="Address" />
                            </div>
                        </div>

                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="small text-dark ft-medium">Profile Image<span style="font-size: 8px"> (Optional)</span></label>
