                                        ...
                                        <div class="card-body pt-0">
                                            <div class="inner_widget_link">
                                                <ul class="no-ul-list">
                                                    ...
                                                    <li>
                                                        <input id="{{ $categories->id }}" class="checkbox-custom" name="category" type="radio" value="{{ $categories->id }}">
                                                        <label for="{{ $categories->id }}" class="checkbox-custom-label">{{ $categories->category_name }}<span>142</span></label>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                                ...
                                                <ul class="no-ul-list">
                                                    @foreach ($all_products as $product)
                                                        <li>
                                                            ...
                                                            <label for="brands1" class="checkbox-custom-label">{{ $product->brand }}<span>142</span></label>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                            ...
                                            <div class="text-left">
                                                @foreach ($all_colors as $color)
                                                    <div class="form-check form-option form-check-inline mb-1">
                                                        ...
                                                        <label class="form-option-label rounded-circle" for="whitea8"><span class="form-option-color rounded-circle" style="background: {{ $color->color_code }}"></span></label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
