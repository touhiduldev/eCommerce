                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea name="addi_info" class="form-control ht-50"></textarea>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <div class="cart_single_caption pl-2">
                                            ...
                                            <h4 class="fs-md ft-medium mb-3 lh-1">BDT {{ $cart->rel_to_product->after_discount }} X {{ $cart->quantity }} = TK {{ $cart->rel_to_product->after_discount*$cart->quantity }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="form-group">
                        ...
                        <ul class="no-ul-list">
                            ...
                            <li>
                                ...
                                <label for="c4" class="radio-custom-label"><img src="https://i.postimg.cc/mr8C5dpW/footer-logo.png" width="20" alt=""> Pay With SSLCommerz</label>
                            </li>
                            <li>
                                <input id="c5" value="3" class="radio-custom" name="payment_method" type="radio">
                                <label for="c5" class="radio-custom-label"><img src="https://i.postimg.cc/cHL6t0cV/001-stripe.png" width="20" alt=""> Pay With Stripe</label>
                            </li>
                            <li>
                                <input id="c6" value="4" class="radio-custom" name="payment_method" type="radio">
                                <label for="c6" class="radio-custom-label"><img src="https://i.postimg.cc/28Kyqsqt/001-paypal.png" width="20" alt=""> Pay With PayPal</label>
                            </li>
                        </ul>
                    </div>
                </div>
...
@section('footer_script')
    <script>
        $('.delivery').click(function(){
            ...
            var grand_total = parseInt(charge)+parseInt(sub_total);
            $('#charge').html(charge);
