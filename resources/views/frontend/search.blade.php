                    ...
                    <div class="search-sidebar-body">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group px-0 mt-3">
                                <a href="{{ route('search') }}" class="btn form-control text-danger">Reset</a>
                            </div>
                        </div>
                        <div class="single_search_boxed">
                            ...
                            <div class="widget-boxed-body collapse show" id="pricing" data-parent="#pricing">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group px-3" id="submit_btn">
                                            ...
                                            <div class="inner_widget_link">
                                                <ul class="no-ul-list">
                                                    @foreach ($categories as $category)
                                                        <li>
                                                            <input id="category{{ $category->category_name }}" class="category_id" name="category_id" type="radio" value="{{ $category->id }}"
                                                            ...
                                                            >
                                                            <label for="category{{ $category->category_name }}" class="checkbox-custom-label">{{ $category->category_name }}<span>{{ App\Models\Product::where('category_id', $category->id)->count() }}</span></label>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                ...
                                <div class="side-list no-border">
                                    ...
                                    <div class="single_filter_card">
                                        <div class="card-body pt-0">
                                            <div class="inner_widget_link">
                                                <ul class="no-ul-list">
                                                    @foreach ($all_products as $brand)
                                                        <li>
                                                            <input id="brands{{ $brand->brand }}" class="checkbox-custom" name="brand_id" type="radio">
                                                            <label for="brands{{ $brand->brand }}" class="checkbox-custom-label">{{ $brand->brand }}<span></span></label>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                                ...
                                                @foreach ($sizes as $size)
                                                    <div class="form-check form-option form-check-inline mb-2">
                                                        <input id="size{{ $size->id }}" class="size_idd" name="size_id" type="radio" value="{{ $size->id }}"
                                                            ...
                                                            @endif
                                                            >
                                                        <label for="size{{ $size->id }}" class="checkbox-custom-label">{{ $size->size }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-9 col-lg-8 col-md-7 col-sm-12">
                                    <div class="filter_wraps d-flex align-items-center justify-content-end m-start">
                                        <div class="single_fitres mr-2 br-right">
                                            <select class="custom-select simple" name="sort" id="sort">
                        ...
                        <div class="product_grid card b-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{ asset('uploads/products/preview/'.$product->preview) }}" alt="..."></a>
                                </div>
                            </div>
